...
// zoneCache and zoneCacheX are local-only — we no longer use go:linkname
// to alias net.zoneCache because Go 1.25 removed/renamed that symbol.
// The zone cache is a nice-to-have optimization for IPv6 scope zone
// resolution but not critical for correct operation.
