...
| `internal/tunnel` | config.go, device.go, tun.go, netlink.go, config_test.go, netlink_test.go | **Implemented + tested** |
...
| `golang.org/x/sys` | v0.33.0 | Netlink syscalls for TUN configuration (non-root) |
