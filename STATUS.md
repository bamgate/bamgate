...
|---------|-------|--------|
| `cmd/riftgate` | main.go, cmd_up.go, cmd_down.go, cmd_init.go, cmd_init_test.go, cmd_status.go, cmd_genkey.go, cmd_install.go | **Implemented + tested** — Cobra subcommands: up, down, init, status, genkey, install |
...
| `worker/` | hub.go, main.go, src/worker.mjs | **Implemented + deployed** — TinyGo 414KB Wasm, Cloudflare Workers free tier |
